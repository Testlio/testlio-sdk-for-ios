...
#ifndef TESTLIOSDK_SWIFT_H
#define TESTLIOSDK_SWIFT_H
...
typedef SWIFT_ENUM(NSInteger, TestlioInvocation, open) {
  TestlioInvocationShake = 0,
  TestlioInvocationScreenshot = 1,
  TestlioInvocationTwoFingersSwipeLeft = 2,
  TestlioInvocationRightEdgePan = 3,
  TestlioInvocationFloatingButton = 4,
};
